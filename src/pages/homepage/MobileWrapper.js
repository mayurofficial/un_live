        ...
        <div className={styles.mobile_wrapper}>
            ...
            <div className={styles.mobile_herosection}>
                ...
                <div className={styles.hero_card_wrapper}>
                    <h1>About ARIS</h1>
                    <p>The Advanced Reactor Information System (ARIS) is a database designed and maintained by the IAEAs Nuclear Power Technology Development Section (NPTDS) since 2009.</p>
